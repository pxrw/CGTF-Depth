...
parser.add_argument('--save_viz', help='if set, save visulization of the outputs', default=False)
...
def test(params):
    ...
    model = ConvGuidedDepth(version='large07', inv_depth=False, max_depth=args.max_depth)

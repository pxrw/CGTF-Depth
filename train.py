...
from utils.utils import post_process_depth, flip_lr, silog_loss, compute_errors, eval_metrics, \
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = ConvGuidedDepth(version=args.encoder, inv_depth=False, max_depth=args.max_depth, pretrained=args.pretrain)
    model.train()

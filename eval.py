...
from model.convguideddepth import ConvGuidedDepth
...
parser = argparse.ArgumentParser(description='CoGF PyTorch implementation.', fromfile_prefix_chars='@')
parser.convert_arg_line_to_args = convert_arg_line_to_args

parser.add_argument('--model_name',                type=str,   help='model name', default='CoGF')
...
if args.dataset == 'kitti' or args.dataset == 'nyu':
    from dataloader.dataloader import NewDataLoader
elif args.dataset == 'kittipred':
    from dataloader.dataloader_kittipred import NewDataLoader
...
def main_worker(args):
    ...
    model = ConvGuidedDepth(version=args.encoder, inv_depth=False, max_depth=args.max_depth, pretrained=None)
    model.train()
